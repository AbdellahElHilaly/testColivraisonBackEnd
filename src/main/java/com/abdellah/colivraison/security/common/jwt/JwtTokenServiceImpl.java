package com.abdellah.colivraison.security.common.jwt;
...
import com.abdellah.colivraison.security.utils.env.SecurityEnvironment;
...
public class JwtTokenServiceImpl implements JwtTokenService {
    ...
    public String generateToken(String username, TokenType tokenType) {
        return Jwts.builder()
                ...
                .setExpiration(securityEnvironment.getTokenExpirationDate(tokenType))
    ...
    public String generateRefreshToken(String username, HttpServletRequest httpServletRequest) {
        ...
        return Jwts.builder()
                ...
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(securityEnvironment.getTokenExpirationDate(TokenType.REFRESH_TOKEN))
                .signWith(getSecretKey())
                .compact();
    }
