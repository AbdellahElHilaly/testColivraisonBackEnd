package com.abdellah.colivraison.security.common.config;


import com.abdellah.colivraison.security.common.exception.CustomAccessDeniedHandler;
import com.abdellah.colivraison.security.common.exception.CustomAuthenticationEntryPoint;
import com.abdellah.colivraison.security.common.filter.JwtAuthFilter;
import com.abdellah.colivraison.security.common.filter.JwtRefreshTokenFilter;
        ...
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/api/v1/auth/login", "/api/v1/auth/refresh",
                                "/api/v1/auth/test-token", "/api/v1/super-admin/seeders")
